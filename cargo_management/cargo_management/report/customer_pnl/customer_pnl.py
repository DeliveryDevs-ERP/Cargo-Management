...
def get_columns(data, expense_types):
    columns = [
        ...
        {"label": _("Weight"), "fieldname": "f_weight", "fieldtype": "float", "width": 60},
        ...
        {"label": _("Customer"), "fieldname": "BOcustomer", "fieldtype": "Data", "width": 100},
        ...
        {"label": _("Transport Type"), "fieldname": "transport_type", "fieldtype": "Data", "width": 100},
        {"label": _("Pickup Location"), "fieldname": "pickup_location", "fieldtype": "Data", "width": 100},
        {"label": _("Dropoff Location"), "fieldname": "dropoff_location", "fieldtype": "Data", "width": 100},
...
def get_data(filters, expense_types):
    ...
    data_query = f"""
        ...
        ORDER BY
            BO.name
    """
    return frappe.db.sql(data_query, {'from_date': filters.get("from_date"), 'to_date': filters.get("to_date"), 'customer': filters.get("customer")}, as_dict=True)
