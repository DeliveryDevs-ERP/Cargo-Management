...
class FPLRoadJob(Document):
    ...
    def validate(self):
        if (self.pickup_arrival and self.pickup_departure) and (self.dropoff_arrival and self.dropoff_completed) and self.status != "Completed":
            if self.vehicle_number and self.vehicle_supplier:
